import { useBalanceContext } from "@/context/BalanceContext"import { useCCTXsContext } from "@/context/CCTXsContext"
mport { networks } from "@zetachain/networks"
iport { getAddress } from "@zetachain/protocol-contracts"
imort { prepareData } from "@zetachain/toolkit/client"
imprt { parseEther } from "viem"
impot { useAccount } from "wagmi"

impot { useEthersSigner } from "@/hooks/useEthersSigner"

impor { useNFT } from "./useNFT"
